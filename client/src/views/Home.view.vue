		...
		<div class="grid-container">
			...
			<aside class="sidenav">
				<ul class="sidenav__list">
					...
					<li class="sidenav__list-item" @click="clickNavItem(4)">
						Vanchor (a faire)
					</li>
...
export default {
	name: 'Home',
	components: {
		Dashboard: () => import('@/components/dashboard.component.vue'),
		Note: () => import('@/components/note.component.vue'),
		Timer: () => import('@/components/timer.component.vue'),
		Todo: () => import('@/components/todo.component.vue'),
		Vanchor: () => import('@/components/vanchor.component.vue'),
	},
	setup() {
		const navItem = ref([]);
		// const data = reactive({
